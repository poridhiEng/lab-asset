# Master Slave DB Replication with Health Check
...
![text](https://github.com/poridhiEng/poridhi-labs/raw/main/Poridhi%20Labs/System%20Design%20Labs%20Using%20AWS/Lab%2003/images/systemDesign-lab3-final.drawio.svg)
...
1. **Database Cluster**: `master-0`, `replica-az-a-0`, `replica-az-b-0`.
...
![alt text](https://github.com/poridhiEng/poridhi-labs/raw/main/Poridhi%20Labs/System%20Design%20Labs%20Using%20AWS/Lab%2003/images/image.png)
...
You will be prompted to login to your pulumi account. If you don't have one, you can sign up for free at [pulumi.com](https://www.pulumi.com/). Then create a pulumi token and paste it in the terminal. After login, you will be prompted to provide necessary details for the project. Go with the flow and provide the necessary details.

> Make sure to select the region as `ap-southeast-1`.
...
![alt text](https://github.com/poridhiEng/poridhi-labs/raw/main/Poridhi%20Labs/System%20Design%20Labs%20Using%20AWS/Lab%2003/images/image-9.png)
...
![alt text](https://github.com/poridhiEng/poridhi-labs/raw/main/Poridhi%20Labs/System%20Design%20Labs%20Using%20AWS/Lab%2003/images/image-10.png)
...
![alt text](https://github.com/poridhiEng/poridhi-labs/raw/main/Poridhi%20Labs/System%20Design%20Labs%20Using%20AWS/Lab%2003/images/image-11.png)
...
You may change the hostname to `replica-az-a-0`, `replica-az-b-0` and `app-server` by running the following command in each of the instances:
...
![alt text](https://github.com/poridhiEng/poridhi-labs/raw/main/Poridhi%20Labs/System%20Design%20Labs%20Using%20AWS/Lab%2003/images/image-12.png)
...
This configuration allows the master DB to send WAL (Write-Ahead Logging) to the replicas and the replicas to receive WAL from the master. 

- `Listen addresses` is set to `*` to allow connections from any IP address.
- `Wal level` is set to `replica` to allow the replicas to receive WAL from the master.
- `Max wal senders` is set to 10 to allow 10 concurrent connections to the master.
- `Max replication slots` is set to 10 to allow 10 concurrent connections to the replicas.

![alt text](https://github.com/poridhiEng/poridhi-labs/raw/main/Poridhi%20Labs/System%20Design%20Labs%20Using%20AWS/Lab%2003/images/image-13.png)
...
These lines allow the master DB to connect to the replicas and the application server to connect to the master DB and the replicas. 
...
![alt text](https://github.com/poridhiEng/poridhi-labs/raw/main/Poridhi%20Labs/System%20Design%20Labs%20Using%20AWS/Lab%2003/images/image-14.png)
...
![alt text](https://github.com/poridhiEng/poridhi-labs/raw/main/Poridhi%20Labs/System%20Design%20Labs%20Using%20AWS/Lab%2003/images/image-15.png)
...
![alt text](https://github.com/poridhiEng/poridhi-labs/raw/main/Poridhi%20Labs/System%20Design%20Labs%20Using%20AWS/Lab%2003/images/image-16.png)
...
![alt text](https://github.com/poridhiEng/poridhi-labs/raw/main/Poridhi%20Labs/System%20Design%20Labs%20Using%20AWS/Lab%2003/images/image-17.png)
...
![alt text](https://github.com/poridhiEng/poridhi-labs/raw/main/Poridhi%20Labs/System%20Design%20Labs%20Using%20AWS/Lab%2003/images/image-18.png)
...
![alt text](https://github.com/poridhiEng/poridhi-labs/raw/main/Poridhi%20Labs/System%20Design%20Labs%20Using%20AWS/Lab%2003/images/image-19.png)
...
![alt text](https://github.com/poridhiEng/poridhi-labs/raw/main/Poridhi%20Labs/System%20Design%20Labs%20Using%20AWS/Lab%2003/images/image-20.png)
...
![alt text](https://github.com/poridhiEng/poridhi-labs/raw/main/Poridhi%20Labs/System%20Design%20Labs%20Using%20AWS/Lab%2003/images/image-21.png)
...
![alt text](https://github.com/poridhiEng/poridhi-labs/raw/main/Poridhi%20Labs/System%20Design%20Labs%20Using%20AWS/Lab%2003/images/image-22.png)
...
![alt text](https://github.com/poridhiEng/poridhi-labs/raw/main/Poridhi%20Labs/System%20Design%20Labs%20Using%20AWS/Lab%2003/images/image-23.png)
...
![alt text](https://github.com/poridhiEng/poridhi-labs/raw/main/Poridhi%20Labs/System%20Design%20Labs%20Using%20AWS/Lab%2003/images/image-24.png)
...
![alt text](https://github.com/poridhiEng/poridhi-labs/raw/main/Poridhi%20Labs/System%20Design%20Labs%20Using%20AWS/Lab%2003/images/image-25.png)
...
2. **Start in production mode**  
   ...
   ![alt text](https://github.com/poridhiEng/poridhi-labs/raw/main/Poridhi%20Labs/System%20Design%20Labs%20Using%20AWS/Lab%2003/images/image-26.png)
...
- **Expected Response:**
    ...
    ![alt text](https://github.com/poridhiEng/poridhi-labs/raw/main/Poridhi%20Labs/System%20Design%20Labs%20Using%20AWS/Lab%2003/images/image-27.png)
...
- **Expected Response:**
    ...
    ![alt text](https://github.com/poridhiEng/poridhi-labs/raw/main/Poridhi%20Labs/System%20Design%20Labs%20Using%20AWS/Lab%2003/images/image-28.png)
...
- **Expected Response:**
    ...
    ![alt text](https://github.com/poridhiEng/poridhi-labs/raw/main/Poridhi%20Labs/System%20Design%20Labs%20Using%20AWS/Lab%2003/images/image-29.png)
...
- **Expected Response:**
    ...
    ![alt text](https://github.com/poridhiEng/poridhi-labs/raw/main/Poridhi%20Labs/System%20Design%20Labs%20Using%20AWS/Lab%2003/images/image-30.png)
...
- **Expected Response:**
    ...
    ![alt text](https://github.com/poridhiEng/poridhi-labs/raw/main/Poridhi%20Labs/System%20Design%20Labs%20Using%20AWS/Lab%2003/images/image-31.png)
...
![alt text](https://github.com/poridhiEng/poridhi-labs/raw/main/Poridhi%20Labs/System%20Design%20Labs%20Using%20AWS/Lab%2003/images/image-32.png)

Here we can see that the data is replicated to the replicas.

### Test in the Application Server

Connect to the application server and check the `combined.log` file in the `db-cluster-app` directory.

```bash
cat db-cluster-app/combined.log
```

![alt text](https://github.com/poridhiEng/poridhi-labs/raw/main/Poridhi%20Labs/System%20Design%20Labs%20Using%20AWS/Lab%2003/images/image-33.png)

Here we can see that the write operation is performed on the master DB and the read operation is performed on the master DB and replicas.


### Clean Up

Delete the resources created in the lab.

```bash
pulumi down --yes
```

![alt text](https://github.com/poridhiEng/poridhi-labs/raw/main/Poridhi%20Labs/System%20Design%20Labs%20Using%20AWS/Lab%2003/images/image-34.png)
